...
C:\DASI\Skripte\Powershell\Working\Manage-Files\Get-FilesFrmFolderSrtdByLstWrTmUTC_20220302-61312.ps1 -strFolderPath $strFolderPath -strSortOrder Descending |ForEach-Object{
