...
process{
 ...
 $strScriptMySettings+=-join('[string](New-Variable -Name strMySettingsScriptName -Value ''',$strMySettingsScriptName,''' -Option AllScope,Constant -Force -Scope Global)',$strBreak)
