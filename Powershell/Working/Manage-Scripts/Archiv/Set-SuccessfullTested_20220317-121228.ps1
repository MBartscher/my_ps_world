...
process{
 ...
 if(Test-Path variable:fldlgSelectFile){Remove-Variable -Name fldlgSelectFile -Force}
 if(Test-Path variable:flinfFile){Remove-Variable -Name flinfFile -Force}
 if(Test-Path variable:aflinfSameScriptDiffVers){Remove-Variable -Name aflinfSameScriptDiffVers -Force}
 if(Test-Path variable:i){Remove-Variable -Name i -Force}
 if(Test-Path variable:flinfSetAliases){Remove-Variable -Name flinfSetAliases -Force}
 Write-Errorlog
}