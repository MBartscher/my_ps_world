...
process{
 ...
 if($VerbosePreference){New-Item -Path C:\DASI\Skripte\Powershell\Working\ -Name MyAliases.ps1 -ItemType File -Value $strScriptAliases -Force}
 else{New-Item -Path C:\DASI\Skripte\Powershell\Working\ -Name MyAliases.ps1 -ItemType File -Value $strScriptAliases -Force|Out-Null}
}
end{
