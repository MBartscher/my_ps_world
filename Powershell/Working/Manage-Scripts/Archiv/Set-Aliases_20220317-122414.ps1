...
process{
 ...
 if(Test-Path variable:flinfScripts){Remove-Variable -Name flinfScripts -Force}
 if(Test-Path variable:i){Remove-Variable -Name i -Force}
 if(Test-Path variable:j){Remove-Variable -Name j -Force}
 if(Test-Path variable:strScriptAliases){Remove-Variable -Name strScriptAliases -Force}
 if(Test-Path variable:Matches){Remove-Variable -Name Matches -Force}
 if(Test-Path variable:strFolderPath){Remove-Variable -Name strFolderPath -Force}
 Write-Errorlog
}