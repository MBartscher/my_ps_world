...
process{
 ...
 $strScriptAliases+=-join((Get-Content -Path C:\DASI\Skripte\Powershell\Working\MyAliases.ps1 -Force -ReadCount 0),"New-Variable -Name strAliasMask -Value '^.[^_\.]*' -Option AllScope,ReadOnly -Force -Scope Global")
