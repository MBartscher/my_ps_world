...
process{
 ...
 $strScriptAliases+=-join('New-Variable -Name strAliasMask -Value ',$strAliasMask,' -Option AllScope,ReadOnly -Force -Scope Global')
 ...
 $Matches=$null
 Write-Errorlog -strExclude "The term '(.|`n)*\\Write-Errorlog_\d{8}-\d{5,6}\.ps1' is not recognized as the name of a cmdlet, function, script file, or operable program."
}
