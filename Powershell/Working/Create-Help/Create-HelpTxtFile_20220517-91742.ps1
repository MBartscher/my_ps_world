...
process{
 ...
 $strFileName=$null
 Write-Errorlog # -strExclude "Get-Help could not find (.|`n)* in a help file in this session\.|Unable to find repository (.|`n)*\. Use Get-PSRepository to see all available repositories\.|Cannot find a variable with the name 'SourceLocation'\.|Unable to find type \[Microsoft\.PowerShell\.Commands\.PowerShellGet\.Telemetry\]\."
}